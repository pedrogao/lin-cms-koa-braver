...
export declare class Token {
     ...
     * @param identity 标识位
     */
    createAccessToken(identity: string | number): any;
    /**
     * 生成refresh_token
     * @param identity 标识位
     */
    createRefreshToken(identity: string | number): any;
    /**
     * verifyToken 验证token
 ...
 * @param options 参数
 */
export declare function createAccessToken(payload: string | object, options?: SignOptions): any;
/**
 * 生成refresh token
 * @param payload 负载，支持 string 和 object
 * @param options 参数
 */
export declare function createRefreshToken(payload: string | object, options?: SignOptions): any;
/**
 * 验证 access token
 * @param token 令牌
 * @param options 选项
