...
function createAccessToken(payload, options) {
    ...
    if (typeof payload === 'string') {
        return jsonwebtoken_1.default.sign({ indentify: payload, type: utils_1.TokenType.ACCESS, exp: jwt.accessExp }, jwt.secret, options);
    }
    else {
        return jsonwebtoken_1.default.sign(Object.assign(Object.assign({}, payload), { type: utils_1.TokenType.ACCESS, exp: exp }), jwt.secret, options);
    }
}
...
function createRefreshToken(payload, options) {
    ...
    // type: TokenType.REFRESH
    if (typeof payload === 'string') {
        return jsonwebtoken_1.default.sign({ indentify: payload, type: utils_1.TokenType.REFRESH, exp: jwt.refreshExp }, jwt.secret, options);
    }
    else {
        return jsonwebtoken_1.default.sign(Object.assign(Object.assign({}, payload), { type: utils_1.TokenType.REFRESH, exp: exp }), jwt.secret, options);
    }
}
